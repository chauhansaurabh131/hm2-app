...
const renderItem = ({item, onPress, isOnline}) => (
  <View style={styles.itemContainer}>
    ...
    <View style={styles.nameContainer}>
      ...
      <Text style={styles.nameDetailTextStyle}>{item.state}</Text>
    </View>
    <View style={styles.nameContainer}>
      <Text style={styles.nameDetailTextStyle}>{item.city},</Text>
      <Text style={styles.nameDetailTextStyle}>{item.county}</Text>
    </View>
...
const PremiumMatchesFlatlistComponent = ({
  data,
  shareButtonPress,
  isOnline,
}) => {
  const renderItemWithPress = ({item}) =>
    renderItem({item, onPress: shareButtonPress, isOnline});
...
export default PremiumMatchesFlatlistComponent;
